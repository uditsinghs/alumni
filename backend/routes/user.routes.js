...
import { changeUserRole, deleteUser, getAllAlumni, getallusers, getLoggedinUser, getSingleAlumni, getUnVerifiedAlumnies, loginUser, LogoutUser, registerUser, verifiedAlumni } from '../controllers/user.controller.js';
