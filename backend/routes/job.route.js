...
import { createJob, deleteJob, getJob, getJobs, getSpecificUserJobs, updateJob } from '../controllers/job.controller.js';


const router = express();
router.post('/create', authenticateUser, authorizeRoles("alumni"), createJob)
router.get('/getall', authenticateUser, getJobs);
router.get('/getuserjob', authenticateUser,authorizeRoles("alumni"), getSpecificUserJobs);
